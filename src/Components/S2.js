...
export default function S1() {
  return (
    ...
    <Carousel style={{width: 'auto', height: '500px', marginTop: '40px'}}>
      <Carousel.Item>
        <img src={e5} text="First slide" style={{width: 'auto', height: '500px'}} />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img src={e6} text="Second slide" style={{width: 'auto', height: '500px'}} />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img src={e7} text="Third slide" style={{width: 'auto', height: '500px'}} />
        <Carousel.Caption>
          <h3>家人闲坐，灯火可亲</h3>
          <p>
          微宿让大自然变得触手可及
